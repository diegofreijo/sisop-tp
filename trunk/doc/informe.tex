...
M'ontelo en el directorio \textbf{/mnt}.
...
Copie un archivo de texto desde un diskette DOS al directorio \textbf{/tmp}

\subsubsection{doswrite FALTA}

Copie el archivo \textbf{/etc/passwd} al diskette DOS
