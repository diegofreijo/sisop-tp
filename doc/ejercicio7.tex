...
\subsubsection{Inciso a}
Se crea directorio \verbº/minix2º y se copia desde \verbº/minixº el archivo 2.0.0. Al iniciar minix presionar ESC. 
Escribir 

\verbº> image=minixº

Si se quiere iniciar con la nueva versión del kernel
	
Escribir 	

\verbº> image= minix2º

Si se quiere iniciar con la versión original.
